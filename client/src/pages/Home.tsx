...
const fallbackProjects = [{ id: 1, title: "ERA shopping Logo & Brand", category: "Branding", description: "A cohesive visual identity built to make brands clear, credible, and memorable.", imageUrl: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&q=80&w=800" }, { id: 2, title: "Jenan Yemeni Honey Logo Branding", category: "Branding", description: "A warm identity system for a distinctive Yemeni honey brand.", imageUrl: "https://images.unsplash.com/photo-1586717791821-3f44a563fa4c?auto=format&fit=crop&q=80&w=800" }, { id: 3, title: "Ekleel Alenayah Medical Company Logo Brand", category: "Medical Branding", description: "A clear, trustworthy identity for a modern medical company.", imageUrl: "https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?auto=format&fit=crop&q=80&w=800" }];
...
export default function Home() {
  ...
  const pageSettings = parsePageEditorSettings(data?.sections, "home");
